...
print("USING BOVINE MEAN STEP DIFFERENCE OVER ALL COWS:")

print("MEAN STEP DIFFERENCE (30MIN.):")
print("---BALANCING DATA---")
X = gen['step_diff_30min_mean_overall'].values.reshape(-1, 1)
y = gen['estrus'].values
...
os_data_X = pd.DataFrame(data=os_data_X,columns=['step_diff_30min_mean_overall'] )
...
print("---BALANCING DATA---")
X = gen['step_diff_hr_mean_overall'].values.reshape(-1, 1)
y = gen['estrus'].values
...
os_data_X,os_data_y=os.fit_resample(X_train, y_train)
# balanced train data to be used
os_data_X = pd.DataFrame(data=os_data_X,columns=['step_diff_hr_mean_overall'] )
os_data_y= pd.DataFrame(data=os_data_y,columns=['estrus'])
...
print("---BALANCING DATA---")
X = gen['step_diff_one_half_mean_overall'].values.reshape(-1, 1)
y = gen['estrus'].values
...
os_data_X,os_data_y=os.fit_resample(X_train, y_train)
# balanced train data to be used
os_data_X = pd.DataFrame(data=os_data_X,columns=['step_diff_one_half_mean_overall'] )
os_data_y= pd.DataFrame(data=os_data_y,columns=['estrus'])
...
print("---BALANCING DATA---")
X = gen['step_diff_3hr_mean_overall'].values.reshape(-1, 1)
y = gen['estrus'].values
...
os_data_X,os_data_y=os.fit_resample(X_train, y_train)
# balanced train data to be used
os_data_X = pd.DataFrame(data=os_data_X,columns=['step_diff_3hr_mean_overall'] )
os_data_y= pd.DataFrame(data=os_data_y,columns=['estrus'])
...
print("---BALANCING DATA---")
X = gen['step_diff_6hr_mean_overall'].values.reshape(-1, 1)
y = gen['estrus'].values
...
os_data_X,os_data_y=os.fit_resample(X_train, y_train)
# balanced train data to be used
os_data_X = pd.DataFrame(data=os_data_X,columns=['step_diff_6hr_mean_overall'] )
os_data_y= pd.DataFrame(data=os_data_y,columns=['estrus'])
...
print("---BALANCING DATA---")
X = gen['step_diff_12hr_mean_overall'].values.reshape(-1, 1)
y = gen['estrus'].values
...
os_data_X,os_data_y=os.fit_resample(X_train, y_train)
# balanced train data to be used
os_data_X = pd.DataFrame(data=os_data_X,columns=['step_diff_12hr_mean_overall'] )
os_data_y= pd.DataFrame(data=os_data_y,columns=['estrus'])
# check the numbers of the data
print("Length of oversampled data is ",len(os_data_X))
print("Number of not estrus in oversampled data",len(os_data_y[os_data_y['estrus']==0]))
