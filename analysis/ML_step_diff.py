...
print("USING BOVINE STEPS:")
print("---BALANCING DATA---")
X = gen['Step'].values.reshape(-1, 1)
y = gen['estrus'].values
...
os_data_X = pd.DataFrame(data=os_data_X,columns=['step'] )
...
print("USING BOVINE STEP DIFFERENCE:")
print("---BALANCING DATA---")
X = gen['step_diff'].values.reshape(-1, 1)
y = gen['estrus'].values
...
os_data_X,os_data_y=os.fit_resample(X_train, y_train)
# balanced train data to be used
os_data_X = pd.DataFrame(data=os_data_X,columns=['step_diff'] )
os_data_y= pd.DataFrame(data=os_data_y,columns=['estrus'])
...
print("USING BOVINE STEP DIFFERENCE (30MIN.):")
print("---BALANCING DATA---")
X = gen['step_diff_30min'].values.reshape(-1, 1)
y = gen['estrus'].values
...
os_data_X,os_data_y=os.fit_resample(X_train, y_train)
# balanced train data to be used
os_data_X = pd.DataFrame(data=os_data_X,columns=['step_diff_30min'] )
os_data_y= pd.DataFrame(data=os_data_y,columns=['estrus'])
...
print("USING BOVINE STEP DIFFERENCE (1HR):")
print("---BALANCING DATA---")
X = gen['step_diff_hr'].values.reshape(-1, 1)
y = gen['estrus'].values
...
os_data_X,os_data_y=os.fit_resample(X_train, y_train)
# balanced train data to be used
os_data_X = pd.DataFrame(data=os_data_X,columns=['step_diff_hr'] )
os_data_y= pd.DataFrame(data=os_data_y,columns=['estrus'])
...
print("USING BOVINE STEP DIFFERENCE (1.5HR):")
print("---BALANCING DATA---")
X = gen['step_diff_one_half'].values.reshape(-1, 1)
y = gen['estrus'].values
...
os_data_X,os_data_y=os.fit_resample(X_train, y_train)
# balanced train data to be used
os_data_X = pd.DataFrame(data=os_data_X,columns=['step_diff_one_half'] )
os_data_y= pd.DataFrame(data=os_data_y,columns=['estrus'])
...
print("USING BOVINE STEP DIFFERENCE (3HR):")
print("---BALANCING DATA---")
X = gen['step_diff_3hr'].values.reshape(-1, 1)
y = gen['estrus'].values
...
os_data_X,os_data_y=os.fit_resample(X_train, y_train)
# balanced train data to be used
os_data_X = pd.DataFrame(data=os_data_X,columns=['step_diff_3hr'] )
os_data_y= pd.DataFrame(data=os_data_y,columns=['estrus'])
...
print("USING BOVINE STEP DIFFERENCE (6HR):")
print("---BALANCING DATA---")
X = gen['step_diff_6hr'].values.reshape(-1, 1)
y = gen['estrus'].values
...
os_data_X,os_data_y=os.fit_resample(X_train, y_train)
# balanced train data to be used
os_data_X = pd.DataFrame(data=os_data_X,columns=['step_diff_6hr'] )
os_data_y= pd.DataFrame(data=os_data_y,columns=['estrus'])
...
print("USING BOVINE STEP DIFFERENCE (12HR):")
print("---BALANCING DATA---")
X = gen['step_diff_12hr'].values.reshape(-1, 1)
y = gen['estrus'].values
...
os_data_X,os_data_y=os.fit_resample(X_train, y_train)
# balanced train data to be used
os_data_X = pd.DataFrame(data=os_data_X,columns=['step_diff_12hr'] )
os_data_y= pd.DataFrame(data=os_data_y,columns=['estrus'])
